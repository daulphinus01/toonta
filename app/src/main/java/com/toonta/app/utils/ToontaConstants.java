...
public class ToontaConstants {
    ...
    public static String TOONTA_API = "http://92.222.90.138:8080/toonta-api/";

    public static String TOONTA_USER = "user/";

    public static String TOONTA_SURVEY = "survey/";

    public static String TOONTA_LIST_SURVEY = "survey/list";

    // Id of every YES radio button in this app
    public static int YES_RADIO_BUTTON_ID = 1111111;
